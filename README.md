...
### 4. Pomodoro Timer (`apps/pomodoro-timer`)
업무나 공부의 집중력을 극대화해 주는 모던한 디자인의 뽀모도로 타이머입니다.
- **주요 기능**: 25분 집중 / 5분 휴식 타이머 기능, 애니메이션 원형 프로그레스 바, 집중 모드별 배경 그라데이션 변화, 세션 횟수 로컬스토리지 기록
